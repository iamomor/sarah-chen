      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-light text-[#1a2744] leading-tight">
          ...
          <div className="border border-slate-200/80 bg-white shadow-xl shadow-slate-100/50 p-5 sm:p-6 space-y-6">
            <div className="flex flex-col sm:grid sm:grid-cols-2 gap-3 sm:gap-4 pb-4 border-b border-slate-100 text-[10px] font-bold uppercase tracking-widest text-[#1a2744]">
            ...
            <div className="space-y-6 sm:space-y-5 text-xs md:text-sm">
              {/* Row 1 */}
              <div className="flex flex-col sm:grid sm:grid-cols-2 gap-4 sm:gap-4 pb-6 sm:pb-4 border-b border-slate-50">
                <div className="space-y-1">
                  ...
                  <p className="text-slate-500 font-light leading-relaxed pl-6 text-[11px] sm:text-xs">
                ...
                <div className="space-y-1 opacity-70 mt-2 sm:mt-0">
                  <div className="flex items-center gap-2 font-bold text-slate-500">
                    <X className="w-4 h-4 text-red-400 flex-shrink-0" /> Passive Waiting
                  </div>
                  <p className="text-slate-400 font-light leading-relaxed pl-6 text-[11px] sm:text-xs">
        ...
        <div className="lg:col-span-5 relative mt-8 lg:mt-0 px-2 sm:px-0">
          ...
          <div className="absolute -bottom-2 -right-2 sm:-bottom-4 sm:-right-4 bg-[#1a2744] text-[#c9a96e] py-2.5 px-4 sm:py-4 sm:px-6 relative z-20 inline-block shadow-lg text-[9px] sm:text-[10px]">
