    ...
    <section className="relative h-[85vh] min-h-[650px] flex items-center justify-center overflow-hidden bg-[#1a2744]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          ...
          alt={`Luxury ${region.defaultCity} Architectural Property`}
          fill
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-20 text-center max-w-5xl space-y-8">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif text-white tracking-tight leading-[1.1] font-light">
            Sell Faster. For More. <br />
            <span className="italic font-medium text-[#c9a96e]">With Less Stress.</span>
          </h1>

          <p className="text-sm sm:text-base md:text-xl text-slate-200 font-light max-w-3xl mx-auto leading-relaxed font-sans">
